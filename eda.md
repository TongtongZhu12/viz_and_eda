...
weather_df %>%
  ...
  summarize(
    ...
    median_timian = median(tmin, na.rm = TRUE)
  )
```

    ## # A tibble: 12 × 4
    ##    month      mean_tmax mean_prcp median_timian
    ##    <date>         <dbl>     <dbl>         <dbl>
...
Suppose you want to summarize man columns.
...
<img src="eda_files/figure-gfm/unnamed-chunk-20-1.png" width="90%" />
...
```
    ...
    ## # … with 32 more rows, and abbreviated variable name ¹​temp_ranking
